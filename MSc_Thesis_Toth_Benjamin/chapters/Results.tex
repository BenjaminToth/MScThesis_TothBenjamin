...
\section{Class-Level Performance Evaluation}
...
The highest improvement was achieved for the \texttt{chew} class with a +7.11\% gain in F1 score, while the models were also able to improve the classification of the \texttt{elec} label with gains of +3.42\% in F1 and +4.94\% in PR AUC. 

The proposed method could also achieve moderate improvement on the already well classified \texttt{eyem} label, reaching the highest F1 score of 0.8308 and the highest PR AUC of 0.7901, with gain of +2.59\% and +2.62\% respectively.
